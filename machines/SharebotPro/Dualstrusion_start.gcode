(**** start.gcode for ShareBot, Dualstrusion! ****)
M103 (disable RPM)
...
G130 X20 Y20 Z20 A20 B20 (Lower stepper Vrefs while heating)M6 T0 (wait for toolhead, and HBP to reach temperature)
